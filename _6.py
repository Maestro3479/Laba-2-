#C:\Python34>python E:\GitHub\PythonLabs\LR2\Task#6\6\6\_6.py --source E:\GitHub\PythonLabs\LR2\Task#6\6\6\ReorganizeMe\  --days 2 --size 4096

# ʕ⊙ᴥ⊙ʔ - No memes, keep coding!  (ᵔᴥᵔ)
import sys
import argparse
import os
import shutil
